...
export const AssigmentsModal: React.FunctionComponent<Props> = (props: Props) => {
    //const [isModalOpen, { setTrue: showModal, setFalse: hideModal }] = useBoolean(false);
    const [stdData, setStdData] = React.useState<IAssignment[]>(props.data)
        ...
        <div>
            ...
            >
                <div className={contentStyles.header}>
                    <span id={titleId}>Datos de la asignación</span>
                    <IconButton
                ...
                <div className={contentStyles.body}>
                    ...
                    <TextField label="Tipo" id="type" required defaultValue={stdData[0].type} onChange={(event) => { updateValues(event) }} />
                    <TextField label="Participantes" id="participants" type="number" required defaultValue={stdData[0].participants.toString()} onChange={(event) => { updateValues(event) }} />
                </div>
                <div>
                    {isLoadShow &&
                ...
                <div className={contentStyles.footer}>
                    <Stack horizontal horizontalAlign="end" styles={footerStackStyles}>
                        <DefaultButton text="Borrar" onClick={() => { sendStdData() }} />
