...
export const StudentsCalendar: React.FunctionComponent<ICalendarButtonExampleProps> = (
    ...
    const {
        ...
        showGoToToday = true,
        buttonString = 'Click para el calendario',
    ...
    const onSelectDate = (date: Date): void => {
        ...
        //if(props.onChangeDate) onChangeDate(date)
