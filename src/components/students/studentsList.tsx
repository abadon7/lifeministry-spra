...
const headCells: HeadCell[] = [
    ...
    { id: 'last', numeric: true, disablePadding: false, label: 'Última Asignación' },
...
interface EnhancedTableProps {
    ...
    numSelected: number;
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof IStudent) => void;
...
function EnhancedTableHead(props: EnhancedTableProps) {
    ...
    const createSortHandler = (property: keyof IStudent) => (event: React.MouseEvent<unknown>) => {
...
const StudentsTable = (props: Props) => {
    ...
    const handleRequestSort = (event: React.MouseEvent<unknown>, property: keyof IStudent) => {
